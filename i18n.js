...
(function () {
  ...
  const TRANSLATIONS = {
    ko: {
      ...
      tab_weekly: "주간 정산",
      tab_weekly_sub: "4주 부하 & 부상 진단",
      tab_plan: "7-Day 플랜",
      tab_plan_sub: "맞춤 훈련표 & 카드",
      tab_monthly: "월간 결산",
    ...
    en: {
      ...
      wo_high: "High-Intensity Quality (Zone 3+)",
      ...
      tab_weekly_sub: "ACWR Load & Injury Audit",
      tab_plan: "7-Day Plan",
      tab_plan_sub: "Custom Training & Card",
    ...
    ja: {
      ...
      tab_weekly: "週間集計",
      tab_weekly_sub: "4週間負荷＆怪我診断",
      tab_plan: "7-Day プラン",
      tab_plan_sub: "カスタム計画＆カード",
      tab_monthly: "月間決算",
    ...
    es: {
      ...
      wo_high: "Alta Intensidad Calidad (Zone 3+)",
      ...
      tab_weekly_sub: "Carga ACWR y Lesiones",
      tab_plan: "Plan de 7 Días",
      tab_plan_sub: "Entrenamiento y Tarjeta",
